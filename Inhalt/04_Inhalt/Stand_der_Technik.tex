...
Jedes der Bilder besteht aus $1500x1500$ Pixeln, was einer Fläche von $2.25 km^2$ entspricht.
...
Die Liniendicke der gelabelten Straßen beträgt $7 px$ und ist ungeglättet, da hiermit bessere Ergebnisse erzielt worden sind \cite[85f]{.06.04.2014}.
...
Es besteht lediglich aus 30 Orthophotos ($5:5:20$) mit einer Größe von $609x914$ und einer Auflösung von $1 \frac{px}{m^2}$.
...
$33$ Orthophotos haben eine Auflösung von $25 \frac{cm}{px}$ mit $9000x9500$ Pixeln, $8$ Bilder von $50 \frac{cm}{px}$ mit $4200x4700$ Pixeln \cite{.20.04.2022}.
Die Bilder sind hand-annotiert und beinhalten einen großen Anteil an ländlicher Gebieten.
...
Der Datensatz besteht aus $6226$ Satellitenbildern in RGB mit einer Größe von $1024x1024$.
...
Die Bilder sind ursprünglich über Thailand, Indonesien und Indien mit je ($19584x19584$) Pixeln aufgenommen worden.
...
Der Testdatensatz \textit{Vaihingen/Enz} besteht aus einer Untermenge der Daten, welche für einen Test von digitalen Luftbildkameras verwendet werden.
