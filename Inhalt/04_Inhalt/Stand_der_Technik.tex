...
\begin{enumerate}
	...
	\item auf dem Datensatz zur Radwegerkennung, der in dieser Arbeit aus Mangel an Existenz erstellt wird, trainiert zu werden.
...
Bei der semantischen Segmentierung von medizinischen Lungen-Ultraschall-Bildern wurden die besten Ergebnisse für das Dice-Maß 
...
Datensatz vortrainiert wurde, erzielte schlechtere Ergebnisse in Bezug auf das Dice-Maß, wobei allerdings das VGG16-U-Net kleine falsch-positive 
...
Es besteht lediglich aus 30 Orthofotos ($5:5:20$) mit einer Größe von $609{\times}914$ und einer Auflösung von $1 \frac{px}{m^2}$.
...
$33$ Orthofotos haben eine Auflösung von $25 \frac{cm}{px}$ mit $9000{\times}9500$ Pixeln, 
...
\begin{enumerate}
	...
	auf Luftbildern gut zu erkennen sind, deren unterschiedlichen, sehr heterogenen Bestandteile jedoch weniger, 
