...
\begin{enumerate}
	...
	Hintergrundpixel als wahr-positive in den Dice- bzw. \ac{IoU}-Score ein. Die Verzerrung wird noch verstärkt, 
...
Nachfolgend werden aktuelle Ergebnisse zu den Massachusetts- und Deep-Globe-Datensätzen vorgestellt, 
...
\begin{enumerate}
	...
	die Optik der Infrastrukturen sich in anderen Ländern aber unterscheidet, kann diese Arbeit 
	Aufschluss darüber geben, ob Ergebnisse zwischen Städten verschiedener Länder übertragbar sind.     
\end{enumerate} 