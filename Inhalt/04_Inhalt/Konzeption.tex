...
\begin{wrapfigure}{l}{0.40\textwidth}
	...
	% im Abbildungsverzeichnis. Der Text darunter wird
	% tatsächlich angezeigt.
	\caption{Beispiel $512{\times}512$-Ausschnitt aus BikeSat-Datensatz mit roter Maske.}
...
Zunächst ist der Testdatensatz abgespalten. Hierzu wird 15\% vom Hannover-Datensatz und 
20\% von den jeweiligen Datensätzen der restlichen Städte als Testpartition abgespaltet. Da der Hannover-Datensatz so groß ist, wie die Datensätze der
...
getestet und über die in \autoref{sec:eval} ausgewählten Maße bewertet.
