...
augmentationsart (real time während training und random)
jede der folgenden augmentationen wird in jeweils ihrer Domäne random gleichzeitig applied.
Zudem wird für jede Batch geshuffled
Der Trainingsdatensatz wird nach jeder Epoche gemischt. 

\autoref{fig:augmentation} zeigt eine Augmentierung des Bildes und der dazugehörigen Maske aus \autoref{fig:cut-example},
