...
$572~ km^2$ des Bike-Datensatzes also eher wenig ist. Ein Pixel im Karlsruhe-Datensatz entspricht $0,2~m$, 
...
Da es sich um eine andere Stadt handelt und die Bilder visuell anders geartet sind, als aus dem Bike-Datensatz 
kann dieser Datensatz die Generalisierungsfähigkeit des Netzes gut testen, insbesondere, da der Datensatz weder 
im Training noch in der Validation des Bike-Datensatzes vorkommt, wodurch es sich um wahrhaftig neue Eingabedaten für die Modedelle handelt. 
...
Damit ergeben sich bei 143 Bildern $143 \cdot 400 = 57.200$ $512 \times 512$-Bildausschnitte für den Bike-Datensatz. 
