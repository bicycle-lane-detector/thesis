...
\newcommand{\bearbeitungszeitraum}{01.10.2022 - 22.05.2023}
...
\hyphenation{Deep-Globe}
\hyphenation{Bike-Sat}
...
\include{Inhalt/04_Inhalt/orthophoto_source.tex}
...
\include{Inhalt/04_Inhalt/Motivation}
\include{Inhalt/04_Inhalt/Stand_der_Technik}
\include{Inhalt/04_Inhalt/Konzeption}
\include{Inhalt/04_Inhalt/Implementierung}
\include{Inhalt/04_Inhalt/Ergebnisse}
\include{Inhalt/04_Inhalt/Diskussion}
